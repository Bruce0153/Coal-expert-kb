...
class ChunkingConfig(BaseModel):
    ...
    profile_by_section: dict[str, ChunkingProfile] = Field(default_factory=lambda: {
...
class RetrievalConfig(BaseModel):
    ...
    drop_sections: list[str] = Field(default_factory=lambda: ["references", "acknowledgements", "contents", "appendix"])
...
class IngestionConfig(BaseModel):
    ...
    include_exts: list[str] = Field(default_factory=lambda: ["pdf", "txt", "md", "html", "docx", "pptx", "csv", "xlsx", "json", "jsonl"])
