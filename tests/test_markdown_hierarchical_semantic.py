...
from coal_kb.ingestion.chunking.markdown_hierarchical_semantic import parse_markdown_sections
from coal_kb.ingestion.chunking.splitter import split_docs_markdown_hierarchical_semantic
from coal_kb.tokenization.tokenizer import count_tokens
...
def test_table_block_is_atomic() -> None:
    ...
    chunks = split_docs_markdown_hierarchical_semantic(docs, {"max_parent_tokens": 50, "max_child_tokens": 20, "overlap_tokens": 0, "similarity_threshold": 0.9, "heading_max_depth": 4, "embedding_backend": "lexical"})
...
def test_token_limit_enforced() -> None:
    md = "# T\n" + "句子。" * 200
    docs = [Document(page_content=md, metadata={"source_file": "x.pdf", "format": "markdown"})]
    chunks = split_docs_markdown_hierarchical_semantic(docs, {"max_parent_tokens": 80, "max_child_tokens": 30, "overlap_tokens": 0, "similarity_threshold": 0.0, "heading_max_depth": 4, "embedding_backend": "lexical"})
...
def test_semantic_boundary_split_on_low_similarity() -> None:
    ...
    chunks = split_docs_markdown_hierarchical_semantic(docs, {"max_parent_tokens": 200, "max_child_tokens": 200, "overlap_tokens": 0, "similarity_threshold": 0.95, "heading_max_depth": 4, "embedding_backend": "lexical"})
